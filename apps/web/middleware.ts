...
export const config = {
  matcher: ["/dashboard/:path*", "/spaces/:path*", "/trends/:path*", "/devices/:path*", "/vision/:path*", "/hardware/:path*", "/agent/:path*", "/emotion/:path*", "/models/:path*", "/rules/:path*", "/evaluation/:path*", "/audit/:path*"]
};
