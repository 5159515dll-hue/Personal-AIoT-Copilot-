...
def main() -> int:
    ...
    checks = [
        ...
        ("总览页可渲染", lambda: check_html(authed_client, web_base_url, "/dashboard?source=mock", ["空间总览", "情感陪伴", "最近审计活动"], args.timeout)),
        ...
        ("情感陪伴页可渲染", lambda: check_html(authed_client, web_base_url, "/emotion", ["情感陪伴", "多模态情绪感知", "策略门控"], args.timeout)),
